package com.shareniu.shareniu_flowable_study.network.association;
...
public class ShareniuTaskTest {
	...
	public void deployOneTaskCaseDefinition() {
		oneTaskCaseDeploymentId = cmmnRepositoryService.createDeployment()
				.addClasspathResource("com/shareniu/shareniu_flowable_study/network/association/shareniu-association-entryCriterion.cmmn.xml")
				.deploy().getId();
	...
	public void testBasicNonBlocking() {
		CaseInstance caseInstance = cmmnRuntimeService.createCaseInstanceBuilder()
				.caseDefinitionKey("shareniu-association")
				.start();
	}
	@Test
	public void triggerPlanItemInstance() {
		String caseInstanceId = "f3eb8410-4238-11e8-bc47-52486683f3d2";
		PlanItemInstance planItemInstance = cmmnRuntimeService.createPlanItemInstanceQuery()
				.caseInstanceId(caseInstanceId).planItemInstanceElementId("planItem2")
