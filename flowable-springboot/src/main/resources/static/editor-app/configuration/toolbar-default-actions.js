    ...
    ACTIONS: {
        ...
        undo: function (services) {
            ...
            if (lastCommands) {
                ...
                // impacts org.flowable.db.properties in the selected item
    ...
    function ($scope, $http, editorManager) {
        ...
        $scope.errorGrid = {
            ...
            columnDefs: [
                ...
                {field: 'warning', displayName: 'Critical', cellTemplate:'editor-app/configuration/org.flowable.db.properties/errorgrid-critical.html', width: 100}
            ]
        };
