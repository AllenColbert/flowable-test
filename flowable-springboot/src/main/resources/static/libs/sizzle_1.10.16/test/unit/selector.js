...
/*
	...
	url( "some/url.php" );
		...
		@example url("data/login.html") => "data/login.html?10538358428943"
...
test("class", function() {
	...
	deepEqual( Sizzle(".e.hasOwnProperty.toString", div), [ div.lastChild ], "Classes match Object.prototype org.flowable.db.properties" );
